...
public class MembersAdapter extends RecyclerView.Adapter<MembersAdapter.MembersViewHolder>
{
    ...
    public void onBindViewHolder(MembersViewHolder holder, int position) {
        ...
        holder.deleteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final CreateUser addCircle = nameList.get(holder.getAbsoluteAdapterPosition());
...

    {
        ...
        @BindView(R.id.delete) ImageButton deleteButton;
        ...
        public boolean onMenuItemClick(MenuItem item) {
            ...
            final CreateUser addCircle = nameList.get(getAbsoluteAdapterPosition());
