...
public class MyCircleFragment extends RootFragment implements SwipeRefreshLayout.OnRefreshListener
{
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(item.getItemId()==R.id.navRefresh)
        {
            ...
            transaction.detach(MyCircleFragment.this);
            transaction.attach(MyCircleFragment.this);
            transaction.commit();
            ...
            Toast.makeText(getContext(),"Page Reloaded",Toast.LENGTH_SHORT).show();
        }
